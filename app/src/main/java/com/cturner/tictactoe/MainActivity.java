...
public class MainActivity extends AppCompatActivity {
    ...
    private void createUnfilledBoard() {
        ...
        mAdapter = new CardViewImageAdapter(getApplicationContext(), TOTAL_SPACES, R.drawable.ic_xo_light);
    ...
    /**
     * Clears the board of all Xs and Os and removed all image tints
     */
     ...
     * Otherwise, since we just started a new game above, the user will simply start a new game
     */
    ...
    private void restoreLastStateIfAutoSaveIsOn() {
        ...
        if (mPrefUseAutoSave) {
            ...
            mLastTurnResults = preferences.getString(mKEY_LAST_TURN_RESULTS,
                    getString(R.string.info_defaultValue_lastTurnResults));
            ...
            // Show Last Results
            mSbGame.setText(mLastTurnResults.concat("\n" + getString(R.string.info_game_resumed)));
        }
    }
    ...
    private void restoreTintsIfGameOver(SharedPreferences preferences) {
        ...
        if (mGameOver) {
            ...
            for (int i = 0; i < mAdapter.getItemCount(); i++) {
                ...
                currentSpaceTint = (int) preferences.getLong(currentKeyName, mINVALID_ICON_VALUE_FLAG);
...
*/
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putIntArray(mKEY_TINTS, mAdapter.getSecondaryDataOfModel());
    }
...
*/
    ...
    private void saveTints(SharedPreferences.Editor editor) {
        ...
        if (mGameOver) {
            int[] currentTint = mAdapter.getSecondaryDataOfModel();
...
*/
    ...
    private String getWinningRowColumnOrDiagonalMessage(int rowColLength) {
        ...
        StringBuilder sbMessage = new StringBuilder(getCurrentPlayer());
        sbMessage.append(getString(R.string.info_has_won));
        sbMessage.append("\nWinning ");
        sbMessage.append(mWinType.toString().toLowerCase());
        sbMessage.append(mWinType.equals(WinType.DIAGONAL) ? ": " : " number: ");
        sbMessage.append(mWinType.equals(WinType.DIAGONAL) ?
